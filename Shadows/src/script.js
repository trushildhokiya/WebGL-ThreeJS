...
// spot light
const spotLight = new THREE.SpotLight(0xffffff,0.5,10,Math.PI*0.1,1,1);
spotLight.position.set(0.2,2,3)
...
const shadowPlane = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({alphaMap:shadowTexture,color:0x000000, transparent:true})
    )
...
const tick = () =>
{
    ...
    shadowPlane.material.opacity  = (1- Math.abs(sphere.position.y))* 0.6
